...
<a-tooltip placement="bottom" title="🍭赏点银子，拿去恰饭">
    <p class="rounded-full mx-8 text-center" title="打赏" @click="showReward">
      <svg viewBox="0 0 24 24" class="action-svg" style="width:1.6rem;height:1.6rem;cursor:pointer"><path d="M20 12v8H4v-8M12 2v20M12 2l5 5M12 2L7 7" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </p>
</a-tooltip>
</a-popover> -->
    </div>
